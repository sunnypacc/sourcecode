...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016/6/6 PM 6:00 build INDEXCOIN in fam.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
            block.print();
        assert(block.hashMerkleRoot == uint256("0x238381f42803044f42a8d13548fa371811dacab2e63a7312d5715a8a68d9eea4"));
...
unsigned char pchMessageStart[4] = { 0x33, 0x15, 0x22, 0x6c };
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake)
{
    ...
    if (fProofOfStake)  // attempt to find a coinstake
    {
        ...
        //pblock->nBits = bnProofOfWorkLimit.GetCompact();
